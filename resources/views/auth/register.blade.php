<x-layout>
    ...
    <x-form.form method="POST" action="/register" enctype="multipart/form-data" class="m-[6vh] border border-[#88888833] bg-[#0E0E0E] rounded-[20px] p-6">
        @csrf
        ...
        <x-form.field>
            ...
            <x-form.input type="text" name="name" id="name" placeholder="Your Name" required maxlength="100"/>
        </x-form.field>
         <x-form.field>
            <x-form.label for="nickname">Nickname</x-form.label>
            <x-form.input type="text" name="nickname" id="nickname" placeholder="This nickname will be displayed publicly on the site" required minlength="5" maxlength="35"/>
        </x-form.field>
        <x-form.field>
            <x-form.label for="email">Email</x-form.label>
            <x-form.input type="email" name="email" id="email" placeholder="you@example.com" required maxlength="255"/>
        </x-form.field>
        ...
        <x-form.field>
            ...
            <x-form.input type="textarea" name="bio" id="bio" placeholder="Tell us about yourself" maxlength="160" />
        </x-form.field>
