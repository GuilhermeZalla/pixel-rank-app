        ...
        class="bg-[#0E0E0E] review-link-spoiler sm:w-full md:flex-1/4 lg:flex-1/4" @else
            ...
            <article
                ...
                <div class="flex flex-row">
                    <x-cover class="h-[140px] rounded-[12px] object-contain" src="https://images.igdb.com/igdb/image/upload/t_1080p/{{ $review->game_cover }}.jpg"
...
@else
    ...
    class="bg-[#0E0E0E] {{ $review->contains_spoilers ? 'review-link-spoiler' : '' }} h-60 rounded-[20px]">
        <article
            class="rounded-[20px] p-1 h-[100%] border-3 border-[#88888822] group hover:border-primary hover:bg-[#141414] transition-all duration-300 ease-in-out">
                    ...
                    <div class="flex flex-col justify-start gap-2 flex-5/6 px-4 py-3">
                        <ul class="flex flex-row justify-between items-center gap-3 text-[.75rem]">
                            <li class="flex flex-row justify-center items-center gap-1 opacity-40">
                                ...
                                {{ $review->getPublishedDate() }} <span class="text-[1rem]">&middot;</span> <span class="flex flex-row items-center gap-1">
                                    <x-heroicon-o-eye
                        ...
                        <div class="h-full">
                            ...
                            <p class="pt-2">{{ Str::limit($review->body, 100) }}</p>
                        </div>
