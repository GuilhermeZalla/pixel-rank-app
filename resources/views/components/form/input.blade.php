...
@if($type === 'textarea')
    <textarea {{ $attributes->merge(['class' => 'font-bold resize-none w-full border border-[#8888884A] focus:border-[#8888884A] focus:outline-none p-3 rounded-[5px] text-[.85rem] bg-[#0E0E0E]']) }}></textarea>
